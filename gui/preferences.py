...
class VlMapWidget(QWidget):
    ...
    def initUi(self):
        ...
        self.voiceCombo.addItems([name for name in self.tts.code2Name[self.langCode]])
    ...
    def testVoice(self):
        self.tts().preview(self.tts.code2Name[self.langCode][self.voiceCombo.currentText()])
