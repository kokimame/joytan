...
class Ui_TranslateDialog(object):
    def setupUi(self, TranslateDialog):
        ...
        self.nameCheck_2 = QtWidgets.QCheckBox(TranslateDialog)
        self.nameCheck_2.setChecked(False)
        self.nameCheck_2.setObjectName("nameCheck_2")
        self.verticalLayout_5.addWidget(self.nameCheck_2)
        self.defCheck_2 = QtWidgets.QCheckBox(TranslateDialog)
        self.defCheck_2.setObjectName("defCheck_2")
        self.verticalLayout_5.addWidget(self.defCheck_2)
        self.exCheck_2 = QtWidgets.QCheckBox(TranslateDialog)
        self.exCheck_2.setObjectName("exCheck_2")
        self.verticalLayout_5.addWidget(self.exCheck_2)
    ...
    def retranslateUi(self, TranslateDialog):
        ...
        self.nameCheck_2.setText(_translate("TranslateDialog", "Name"))
        self.defCheck_2.setText(_translate("TranslateDialog", "Definition"))
        self.exCheck_2.setText(_translate("TranslateDialog", "Example"))
