...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.tabTag)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.label_11 = QtWidgets.QLabel(self.tabTag)
        self.label_11.setObjectName("label_11")
        self.verticalLayout_4.addWidget(self.label_11)
        self.tagList = QtWidgets.QListWidget(self.tabTag)
        self.tagList.setAutoFillBackground(True)
        self.tagList.setStyleSheet("")
        self.tagList.setObjectName("tagList")
        self.verticalLayout_4.addWidget(self.tagList)
    ...
    def retranslateUi(self, Preferences):
        ...
        self.label_11.setText(_translate("Preferences", "Current Tags"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabTag), _translate("Preferences", "Tag"))
