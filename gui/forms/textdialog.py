...
class Ui_TextDialog(object):
    def setupUi(self, TextDialog):
        ...
        self.imgSpin.setMaximum(10)
        self.imgSpin.setProperty("value", 3)
        self.imgSpin.setObjectName("imgSpin")
        self.horizontalLayout_5.addWidget(self.imgSpin)
    ...
    def retranslateUi(self, TextDialog):
        ...
        self.label.setText(_translate("TextDialog", " # of images"))
        self.dlAllBtn.setText(_translate("TextDialog", "Download All"))
